...
var availableLocations = []paginationLocation{PAGINATION_LOCATION_HEADER, PAGINATION_LOCATION_BODY, PAGINATION_LOCATION_QUERY_PARAM}
var availableDirections = []paginationDirection{PAGINATION_DIRECTION_NEXT, PAGINATION_DIRECTION_PREVIOUS}
var availableModes = []paginationMode{PAGINATION_MODE_NONE, PAGINATION_MODE_OFFSET, PAGINATION_MODE_PAGE, PAGINATION_MODE_PROPERTY, PAGINATION_MODE_LINK_HEADER}
